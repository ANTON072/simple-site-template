...
function enqueue_my_scripts() {
	...
	if ( $environment === 'production' ) {
			...
			wp_enqueue_style( 'main-style', get_template_directory_uri() . '/dist/bundle.css', array(), $css_version );
			wp_enqueue_script( 'main-script', get_template_directory_uri() . '/dist/bundle.js', array(), $js_version, true );
	} else {
			// development環境の場合
			...
			wp_enqueue_script( 'main-script', get_template_directory_uri() . '/assets/js/main.js', array(), $js_version, true );
	}
}
